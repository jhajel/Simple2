...
public class Robot extends TimedRobot {
  ...
  TalonSRX _talon3 = new TalonSRX(3);
    ...
    double motorOutput2 = _talon2.getMotorOutputPercent();
    double motorOutput3 = _talon3.getMotorOutputPercent();
    ...
    _sb.append("%");	// Percent
    _sb.append((int) (motorOutput2 * 100));
    _sb.append("%");	// Percent
    _sb.append((int) (motorOutput3 * 100));
		_sb.append("%");	// Percent
